...
static const Rule rules[] = {
	...
	{ "Gajim",     NULL,       NULL,       1<< 4,            False,        -1 },
	{ "NetBeans IDE 7.4",     NULL,       NULL,       0,            True,        -1 },
	{ "Wine",     "winbox.exe", NULL,       0,            True,        -1 },
...
static const Layout layouts[] = {
	...
	// { "-|-",      nbstack },    /* first entry is default */
...
static const char *volumeupcmd[]  = { "/home/tdi/bin/pa-vol.sh",  "plus", NULL };
static const char *volumedowncmd[]  = { "/home/tdi/bin/pa-vol.sh",  "minus", NULL };
static const char *thinkvantage[]  = { "pavucontrol",  "plus", NULL };
...
static Key keys[] = {
	...
	{ 0     ,                       0x1008ff41,spawn,           {.v = thinkvantage } },
